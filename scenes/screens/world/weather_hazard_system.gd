...
func _draw_lightning(lightning_position: Vector2, alpha: float) -> void:
	var color := Color(1.0, 0.95, 0.22, 0.95 * alpha)
	draw_line(lightning_position + Vector2(0, -42), lightning_position + Vector2(-10, -8), color, 3.0)
	draw_line(lightning_position + Vector2(-10, -8), lightning_position + Vector2(7, -8), color, 3.0)
	draw_line(lightning_position + Vector2(7, -8), lightning_position + Vector2(-4, 28), color, 3.0)
	draw_circle(lightning_position, 18.0 * alpha, Color(1.0, 0.95, 0.35, 0.20 * alpha))

func _draw_tornado(tornado_position: Vector2, alpha: float) -> void:
	var color := Color(0.82, 0.80, 0.68, 0.78 * alpha)
	draw_arc(tornado_position + Vector2(0, -20), 18.0, 0.2, TAU * 0.9, 24, color, 3.0)
	draw_arc(tornado_position + Vector2(0, -5), 13.0, 0.4, TAU * 0.9, 20, color, 3.0)
	draw_arc(tornado_position + Vector2(0, 8), 8.0, 0.6, TAU * 0.85, 16, color, 2.5)
	draw_arc(tornado_position + Vector2(0, 18), 4.0, 0.8, TAU * 0.75, 12, color, 2.0)
